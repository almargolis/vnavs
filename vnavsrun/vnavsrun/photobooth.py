...
class ProcessStep:
    ...
    def __init__(self, filter_name=None, where=None, parms={}):
        ...
        self.cv_filter_name = None  # this gets set by new_filter()
    ...
    def on_pick_point(self, event):
        # This configures on_image_click() to save the clicked point in a parm.
    ...
    def set_filter(self, filter_name=None, new_parms=None):
        ...
        # print("set_filter()", new_filter_name,  self.cv_filter_name)
        ...
        for ix, this in enumerate(self.info_widgets):
            if ix < len(self.info_data):
                try:
                    ...
                    print("execute_step()", self.ix, self.tab_title)
                    # raise
            else:
...
class Darkroom(vmqtt.VnavsNode):
    ...
    def load_process_file(self, fn):
        ...
        def AssignFilter():
            ...
            # existitng tabs, on_tab_selected() creates a default tab as soon as we delete the last one.
            # This is neater than the options for modifying on_tab_selected() behavior and may be slightly
            # more efficient.
    ...
    def on_tab_selected(self, x):
        ...
        print("Darkroom.on_tab_selected()", tabid, self.notebook_add_id)
    ...
    def delete_process_step(self, ix):
        ...
        print("darkroom.delete_process_step() BEGIN", ix)
        self.gui_update_mode = True
        ...
        for adjust_ix, this_step in enumerate(ProcessStep.steps[ix:]):
            ...
            print("darkroom.delete_process_step() rename tab", ix, this_step.tab_title)
            self.notebook.tkw.tab(this_step.ix, text=this_step.tab_title)
        self.step_execution_needed = True
        self.gui_update_mode = False
        ProcessStep.steps[ix - 1].select_tab(None)
        print("darkroom.delete_process_step() END", len(ProcessStep.steps))
